...
def main():
    ...
    suites = [
        ...
        ("7. Core Features: Docs, Summarizer, Quizzes, Planner & Flashcards", [
            test_calculator_arithmetic_unchanged,
            test_sha256_duplicate_detection,
            test_mcq_validation,
            test_quiz_evaluation_and_weak_topic_pipeline,
    ...
    if total_failed == 0:
        print("[SUCCESS] ALL PRODUCTION INTEGRITY CHECKS PASSED WITH 100% SUCCESS!")
        return 0
    else:
        print(f"[FAILED] {total_failed} check(s) failed. Please review the errors above.")
        return 1

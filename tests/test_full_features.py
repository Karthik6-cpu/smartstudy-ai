...
def test_quiz_generator_parsing_and_fallbacks():
    ...
    # 3. Test generate_structured_quiz method
    quiz = generate_structured_quiz("Operating Systems", num_questions=3, difficulty="Beginner")
    assert len(quiz) == 3
...
if __name__ == "__main__":
    ...
    print("\nAll Quiz, Study Planner, Memory & Progress tests passed successfully! 🎉")
